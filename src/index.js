...
if (!booleanVar) {
  console.log("[Question #34]: ", "falsey"); // should print falsey
}
...
console.log("[Question #67]: ", city === "london"); // should print false
...
console.log("[Question #68]: ", !isVisible); // should print false
...
console.log("[Question #73]: ", days); // should print array with above values

// 74. Remove the first element from 'planets' array.

planets.shift();
console.log("[Question #734: ", planets); // should print array with above values
...
console.log("[Question #91]: ", weight > 50 && weight < 70); // should print false
